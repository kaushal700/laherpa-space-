...
const ServerIndia = () => {
  useEffect(() => {
    document.title = "India Server - La Herpaile";
  }, []);

  const locations = [
    { 
      city: "Mumbai", 
      region: "Maharashtra - Financial Hub",
      latency: "< 2ms",
      features: ["Financial Capital", "Premium Tier-1", "Stock Exchange Connect"],
      flag: "🏙️"
    },
    { 
      city: "Hyderabad", 
      region: "Telangana - Tech Hub",
      latency: "< 3ms",
      features: ["IT Capital", "Cost Effective", "Tech Industry Focus"],
      flag: "💻"
    },
  ];

  const features = [
    { icon: Zap, title: "Blazing Fast", description: "Local infrastructure with minimal latency across India's major cities" },
    { icon: Shield, title: "Data Localization", description: "100% compliant with Indian data protection regulations & RBI guidelines" },
    { icon: Clock, title: "99.99% Uptime", description: "Reliable performance with local redundancy and backup systems" },
    { icon: Users, title: "Hindi & English Support", description: "24/7 bilingual support in local languages" },
  ];

  const specs = [
    { icon: MapPin, text: "2 Major Indian Metros" },
    ...
    <main className="min-h-screen relative overflow-hidden">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-24">
        <div className="absolute inset-0">
          <img src={serverHero} alt="India Server" className="w-full h-full object-cover" />
        ...
        <div className="container relative z-10 text-center px-4">
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-secondary/30 to-accent/30 backdrop-blur-md rounded-full border border-secondary/40 mb-8 shadow-lg shadow-secondary/20">
            <span className="text-secondary font-bold text-lg">🌏 India</span>
          </div>
          
          <h1 className="text-6xl md:text-8xl font-display font-bold text-white mb-8">
            India <span className="text-gradient-warm drop-shadow-lg">Premium Server</span>
          </h1>
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-10 leading-relaxed">
            Powerful local hosting from <span className="text-secondary font-semibold">Mumbai & Hyderabad</span> designed for the Indian subcontinent with blazing fast speeds
          </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-display font-bold mb-6">
              <span className="text-gradient-warm">2 Major</span> Indian Metros
            </h2>
            <p className="text-muted-foreground text-xl max-w-2xl mx-auto">
              Choose the perfect data center location for your business needs in India
            </p>
          </div>
  ...
  >
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <span className="px-4 py-2 bg-secondary/20 text-secondary text-lg font-bold rounded-full">
                      {location.latency}
                    </span>
                  </div>
                  
                  <h3 className="text-3xl font-bold mb-2 group-hover:text-secondary transition-colors">{location.city}</h3>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <span className="inline-block px-6 py-3 bg-gradient-to-r from-secondary/25 to-accent/25 rounded-full text-secondary font-bold mb-6 text-lg">
              ⚡ Why Choose India Server
            </span>
            <h2 className="text-4xl md:text-6xl font-display font-bold mb-6">
              <span className="text-gradient-warm">Local</span> Excellence
            </h2>
          </div>
