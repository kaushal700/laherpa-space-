...
import { Heart, Monitor, CheckCircle, Users, GraduationCap, Sparkles, Star, Zap, Server, Globe, Loader2 } from "lucide-react";
...
const ServerInfo = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!trimmedName || !trimmedEmail || !trimmedCountry || !trimmedPhone) {
      toast({
        title: "Error",
    ...
    // Phone validation - basic check for reasonable phone format
    ...
    try {
      ...
      try {
        const { error: emailError } = await supabase.functions.invoke('send-rdp-notification', {
          body: {
            name: trimmedName,
            email: trimmedEmail,
            country: trimmedCountry,
      ...
      toast({
        ...
        description: "We will review your application and get back to you soon. Check your email for confirmation.",
      });
