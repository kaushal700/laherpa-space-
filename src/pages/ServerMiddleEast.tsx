...
const ServerMiddleEast = () => {
  useEffect(() => {
    document.title = "Middle East Server - La Herpaile";
  }, []);
  ...
  const features = [
    { icon: Zap, title: "Regional Speed", description: "Optimized connectivity for Middle East with ultra-low latency" },
    { icon: Shield, title: "Local Compliance", description: "Full adherence to regional data regulations and privacy laws" },
    { icon: Clock, title: "99.99% Uptime", description: "Reliable infrastructure in strategic locations" },
    { icon: Users, title: "Arabic Support", description: "Native Arabic and English speaking support team 24/7" },
  ];

  const specs = [
    { icon: MapPin, text: "2 Strategic MENA Locations" },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-display font-bold mb-6">
              <span className="text-gradient-warm">2 Strategic</span> MENA Locations
            </h2>
            <p className="text-muted-foreground text-xl max-w-2xl mx-auto">
              Choose the perfect data center location for your Middle East operations
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <span className="inline-block px-6 py-3 bg-gradient-to-r from-accent/25 to-primary/25 rounded-full text-accent font-bold mb-6 text-lg">
              ⚡ Why Choose Middle East Server
            </span>
            <h2 className="text-4xl md:text-6xl font-display font-bold mb-6">
              <span className="text-gradient-warm">Regional</span> Power
            </h2>
          </div>
...
export default ServerMiddleEast;